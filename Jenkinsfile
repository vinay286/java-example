        ...
        stage('Deploy to Tomcat') {
            steps {
                script {
                    ...
                    sh """
                        curl -u admin:123456 --upload-file "http://184.73.144.199:8081/artifactory/maven-releases/works-with-heroku/works-with-heroku-1.0.war"  "http://98.81.160.3:8080/manager/"
                    """
                }
            }
        }
